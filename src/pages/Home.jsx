...
const Home = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen px-4 md:pl-[17rem] lg:px-[28rem]">
            ...
            <div className=" w-20 h-36">
                <img className="mx-auto  max-h-[100px] md:w-[100px]  lg:h-[604px] w-full max-w-[242px]" src="/public/assets/img/fondo-home.png" alt="Background" />
            </div>
        </div>
    );
}
